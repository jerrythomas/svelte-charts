...
export const namedShapes = {
  ...
  shurikan: (s) =>
    `M${0.4 * s} ${0.1 * s}L${0.5 * s} 0L${0.6 * s} ${0.1 * s}` +
    `A ${0.25 * s} ${0.25 * s} 0 0 0 ${0.9 * s} ${0.4 * s}` +
    `L${s} ${0.5 * s}L${0.9 * s} ${0.6 * s}` +
    `A ${0.25 * s} ${0.25 * s} 0 0 0 ${0.6 * s} ${0.9 * s}` +
    `L${0.5 * s} ${s}L${0.4 * s} ${0.9 * s}` +
    `A${0.25 * s} ${0.25 * s} 0 0 0 ${0.1 * s} ${0.6 * s}` +
    `L0 ${0.5 * s}L${0.1 * s} ${0.4 * s}` +
    `A${0.25 * s} ${0.25 * s} 0 0 0 ${0.4 * s} ${0.1 * s}`,
}
